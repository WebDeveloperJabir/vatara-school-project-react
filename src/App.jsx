    ...
    <Router>
      ...
      <main>
        <Routes>
          ...
          <Route path='/about/prizes-from-government' element={<NotMadePage />} />
          ...
          {/* Information */}
          <Route path='/information/teachers' element={<InformationTeachers />} />
          <Route path='/information/teachers/profile-info/:teacherID' element={<TeacherPage />} />
          <Route path='/information/statistics' element={<NotMadePage />} />
          <Route path='/information/school-timing' element={<InformationSchoolTiming />} />
          <Route path='/information/class-routine' element={<InformationClassRoutine />} />
          <Route path='/information/exam-schedule' element={<NotMadePage />} />
          <Route path='/information/yearly-academic-calendar-and-holidays' element={<NotMadePage />} />
          {/* Result */}
          ...
          {/* Admission */}
          <Route path='/admission/how-to-take-admission' element={<NotMadePage />} />
          ...
          <Route path='/facilities/co-curricular-activities' element={<NotMadePage />} />
