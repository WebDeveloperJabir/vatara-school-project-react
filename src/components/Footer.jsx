  ...
  return (
    <footer>
      <div className='upper-content'>
        <div className='left-content'>
          ...
          <div className='email-and-phone'>
            ...
            <div className='phone'>
              ...
              <p style={{ color: "white" }}>0197493722</p>
            </div>
        ...
        <div className='middle-content'>
          ...
          <ul>
            ...
            <li>
              <a href='https://dhakaeducationboard.gov.bd/site/' target='_blank'>
                Dhaka Board
              </a>
            </li>
            <li>
              <a href='https://www.educationboardresults.gov.bd/' target='_blank'>
            ...
            <li>
              <a href='https://en.wikipedia.org/wiki/Secondary_School_Certificate' target='_blank'>
                SSC
              </a>
            </li>
            <li>
              <a href='https://en.wikipedia.org/wiki/Secondary_School_Certificate_(Bangladesh)' target='_blank'>
                SSC Bangladesh
              </a>
            </li>
            <li>
              <a href='https://nctbbook.com/ssc-2026-short-syllabus/' target='_blank'>
      ...
      <div className='lower-content'>
        <p>&#169; 2005 - {currentYear} Vatara Model School. All rights reserved.</p>
      </div>
    </footer>
  );
}
